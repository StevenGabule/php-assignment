@extends('layouts.app', ['model' => 'employee', 'value' => $employee->id])
    ...
    <div class="row justify-content-center">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('employees.update', ['employee' => $employee->id, 'language' => app()->getLocale()]) }}" method="post">
              @csrf
              @method('PUT')
              <div class="col-md-3 mb-3 p-0">
                <label for="validationCustom04">Select the company</label>
                <select name="company_id"
                        class="custom-select @error('company_id') is-invalid @enderror"
